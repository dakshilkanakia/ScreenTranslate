...
struct ContentView: View {
    ...
    var body: some View {
        // A .sheet/.fullScreenCover presented right as the app cold-launches
        // from an App Intent races with UIKit scene setup and crashes
        // (-[_UISceneHostingController _setSheetConfiguration:] unrecognized
        // selector). Swapping the root content directly avoids any
        // presentation-controller machinery entirely.
